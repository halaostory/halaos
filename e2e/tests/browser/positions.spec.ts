...
test.describe('Positions', () => {
  test('page loads at /positions', async ({ adminPage: page }) => {
  ...
  test('position table is visible', async ({ adminPage: page }) => {
    await page.goto(BASE + '/positions');
    await page.waitForLoadState('load', { timeout: 15_000 }).catch(() => {});
  ...
  test('create position button visible', async ({ adminPage: page }) => {
    await page.goto(BASE + '/positions');
    await page.waitForLoadState('load', { timeout: 15_000 }).catch(() => {});
