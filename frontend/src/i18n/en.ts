export default {
  ...
  settings: {
    ...
    apiKeysDesc: "Create API keys for MCP Server, external integrations, and programmatic access.",
    apiKeysAddKey: "Create Key",
    apiKeysName: "Key Name",
    apiKeysNameHint: "e.g., mcp-server, ci-pipeline",
    apiKeysCreated: "API key created",
    apiKeysCreatedWarning: "Copy this key now — it will only be shown once",
    apiKeysRevoke: "Revoke",
    apiKeysRevokeConfirm: "Revoke this API key? Any integrations using it will stop working.",
    apiKeysRevoked: "API key revoked",
    apiKeysNoKeys: "No API keys yet. Create one to use with MCP Server or external tools.",
    apiKeysPrefix: "Key",
  ...
  virtualOffice: {
    ...
    noUnassigned: "All employees have seats assigned.",
    selectEmployee: "Select employee",
  },
  emptyState: {
